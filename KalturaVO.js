 ...
 */
function KalturaEntryVendorTaskUnit(){
	this.unitsUsed = null;
	this.serviceName = null;
}
KalturaEntryVendorTaskUnit.inheritsFrom (KalturaObjectBase);
...
/**
 * @param	resource	KalturaContentResource		Only KalturaEntryResource, KalturaAssetResource and KalturaDocumentImagesResource are supported.
...
/**
 * @param	serviceName	string		.
 * @param	priceUnit	KalturaVendorCatalogItemPricing		.
 */
function KalturaVendorCatalogItemUnitPricing(){
	this.serviceName = null;
	this.priceUnit = null;
}
KalturaVendorCatalogItemUnitPricing.inheritsFrom (KalturaObjectBase);
 ...
 */
function KalturaDocumentImagesResource(){
	this.flavorAssetId = null;
	this.index = null;
}
KalturaDocumentImagesResource.inheritsFrom (KalturaContentResource);
