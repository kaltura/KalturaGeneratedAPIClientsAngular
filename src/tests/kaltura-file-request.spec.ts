    ...
    kalturaClient.request(thumbRequest)
      .subscribe(
        result => {
          ...
          expect(result.url).toBe("https://www.kaltura.com/api_v3/service/thumbasset/action/serve?clientTag=ngx-tests?apiVersion=14.2.0&ks=YWIyZDAxYWRhZmQ1NzhjMzQ5ZmI3Nzc4MzVhYTJkMGI1NDdhYzA5YnwxNzYzMzIxOzE3NjMzMjE7MTUxMjA1MzA1MzsyOzE1MTE5NjY2NTMuNTk7YWRtaW47ZGlzYWJsZWVudGl0bGVtZW50Ozs&thumbAssetId=1_ep9epsxy&format=1");
