...
export interface KalturaReachProfileArgs  extends KalturaObjectBaseArgs {
	...
	defaultSourceLanguage? : KalturaCatalogItemLanguage;
    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				defaultSourceLanguage : { type : 'es', subTypeConstructor : KalturaCatalogItemLanguage, subType : 'KalturaCatalogItemLanguage' },
